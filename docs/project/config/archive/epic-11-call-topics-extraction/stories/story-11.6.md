...
- [x] Consolidated manual test file at `docs/project/config/2026-04-22-epic-11-manual-tests.md` with: migration-run checklist, live extraction walkthrough, tile render checks, artifact-type-card checks, project-settings checks, reset-to-default flow, parked topic flow
- [x] `build-log.md`, `ACTIVE.md`, `codebase.md` updated
- [x] All 6 stories (11.1–11.6) marked done
